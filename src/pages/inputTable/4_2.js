...
function WasteAverage({ onChange, dataset1 }) {
    ...
    useEffect(() => {
        onChange((Number(v0) * Number(v1) * Number(v2) + Number(v0) * Number(v3) * Number(v4) + Number(v0) * Number(v5) * Number(v6) + Number(v0) * Number(v7) * Number(v8) + Number(v0) * Number(v9) * Number(v10) + Number(v0) * Number(v11) * Number(v12) + Number(v0) * Number(v13) * Number(v14) + Number(v0) * Number(v15) * Number(v16) + Number(v0) * Number(v17) * Number(v18) + Number(v0) * Number(v19) * Number(v20)) * 10)
    }, [
            ...
            <div className='table-container'>
                <table>
                    <tbody>
                        ...
                        <tr>
                            <td rowSpan={5 + AddNumber}><input type='text' value={v0} className='Input_form' onChange={(e) => { setV0(e.target.value) }} /></td>

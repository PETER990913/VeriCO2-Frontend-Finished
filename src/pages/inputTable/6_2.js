...
function EmployeeAverage({ onChange }) {
    ...
    const [textv0, setTextV0] = useState('Rail');
    const [textv1, setTextV1] = useState('Car');
    const [textv2, setTextV2] = useState('Foot');
    const [textv3, setTextV3] = useState('Bus');
    ...
    useEffect(() => {
        onChange((Number(v0) * Number(v1) * Number(v2) + Number(v3) * Number(v4) * Number(v5) + Number(v6) * Number(v7) * Number(v8) + Number(v9) * Number(v10) * Number(v11) + Number(v12) * Number(v13) * Number(v14) + Number(v15) * Number(v16) * Number(v17) + Number(v18) * Number(v19) * Number(v20) + Number(v21) * Number(v22) * Number(v23) + Number(v4) * Number(v5) * Number(v26)) / 100 * 10000 * 2 * 235)
    }, [

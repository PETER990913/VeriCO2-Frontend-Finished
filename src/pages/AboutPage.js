  ...
  return (
    <div className='AboutPage' onClick={() => setSideBarFlag(false)}>
      ...
      <div className='selector'>
        <div className='items'>
          <div className={itemNumber === 0 ? 'item selected' : 'item'} onClick={() => setItemNumber(0)}>Methodology</div>
        ...
        <div className='text'>
          <div className='row'>
            <div className='column'>
              ...
              <span><b>VeriCO₂</b> automates the consolidation of scope 1 and 2 emissions from suppliers and customers and/or the retrieval of
                emission factors to provide the mandatory scope 3 disclosures necessary for compliance.</span>
            </div>
      ...
      <div className={itemNumber === 1 ? 'description' : 'hidden'}>
        <div className='pricings'>
          ...
          <div className='price-box'>
            ...
            <div className='bottom'>
              <span className='title'>This plan includes:</span>
              <span>- Unlimited Platform Access 1Yr, 1 User, Up to Three Searches</span>
              <span>- Automated scope 3 emissions quantification for mandatory reporting</span>
              <span>- Exportable Reports</span>
              <span>- Facilitated Onboarding</span>
              <span>- Email Support</span>
          ...
          <div className='price-box'>
            ...
            <div className='bottom'>
              <span className='title'>This plan includes:</span>
              <span>- Unlimited Platform Access 1Yr, 1 User, Unlimited Platform Searches</span>
              <span>- Automated scope 3 emissions quantification for mandatory reporting</span>
              <span>- Exportable Reports</span>
              <span>- Facilitated Onboarding</span>
              <span>- Email Support</span>

            ...
            <div className='scopes-container'>
                <div className='scopes'>
                    <div className='top'>
                        ...
                        <div>
                            <span>{(result1_1 / 1000000).toFixed(1)}K</span>
                            <span>t CO2e</span>
                        </div>
                    </div>
                </div>
            ...
            <div className='scopes-container'>
                <div className='scopes'>
                    <div className='top'>
                        <span>Scope 3 Emission:</span>
                        <div>
                            <span>{(result1_2 / 1000000).toFixed(1)}K</span>
                            <span>t CO2e</span>
                        </div>
                    </div>
                </div>
            ...
            <div className='scopes-container'>
                <div className='scopes'>
                    <div className='top'>
                        <span>Scope 3 Emission:</span>
                        <div>
                            <span>{(result1_3 / 1000000).toFixed(1)}K</span>
                            <span>t CO2e</span>
                        </div>
                    </div>
                </div>
            ...
            <div className='scopes-container'>
                <div className='scopes'>
                    <div className='top'>
                        <span>Scope 3 Emission:</span>
                        <div>
                            <span>{(result1_4 / 1000000).toFixed(1)}K</span>
                            <span>t CO2e</span>
                        </div>
                    </div>
                </div>
            ...
            <div className='scopes-container'>
                <div className='scopes'>
                    <div className='top'>
                        <span>Scope 3 Emission:</span>
                        <div>
                            <span>{(result2_1 / 1000000).toFixed(1)}K</span>
                            <span>t CO2e</span>
                        </div>
                    </div>
                </div>
            ...
            <div className='scopes-container'>
                <div className='scopes'>
                    <div className='top'>
                        <span>Scope 3 Emission:</span>
                        <div>
                            <span>{(result2_2 / 1000000).toFixed(1)}K</span>
                            <span>t CO2e</span>
                        </div>
                    </div>
                </div>
            ...
            <div className='scopes-container'>
                <div className='scopes'>
                    <div className='top'>
                        <span>Scope 3 Emission:</span>
                        <div>
                            <span>{(result2_3 / 1000000).toFixed(1)}K</span>
                            <span>t CO2e</span>
                        </div>
                    </div>
                </div>
            ...
            <div className='scopes-container'>
                <div className='scopes'>
                    <div className='top'>
                        <span>Scope 3 Emission:</span>
                        <div>
                            <span>{(result2_4 / 1000000).toFixed(1)}K</span>
                            <span>t CO2e</span>
                        </div>
                    </div>
                </div>
            ...
            <div className='scopes-container'>
                <div className='scopes'>
                    <div className='top'>
                        <span>Scope 3 Emission:</span>
                        <div>
                            <span>{(result1_15 / 1000000).toFixed(1)}K</span>
                            <span>t CO2e</span>
                        </div>
                    </div>
                </div>
            ...
            <div className='scopes-container'>
                <div className='scopes'>
                    <div className='top'>
                        <span>Scope 3 Emission:</span>
                        <div>
                            <span>{(result3_1 / 1000000).toFixed(1)}K</span>
                            <span>t CO2e</span>
                        </div>
                    </div>
                </div>
            ...
            <div className='scopes-container'>
                <div className='scopes'>
                    <div className='top'>
                        <span>Scope 3 Emission:</span>
                        <div>
                            <span>{(result3_2 / 1000000).toFixed(1)}K</span>
                            <span>t CO2e</span>
                        </div>
                    </div>
                </div>
            ...
            <div className='scopes-container'>
                <div className='scopes'>
                    <div className='top'>
                        <span>Scope 3 Emission:</span>
                        <div>
                            <span>{(result3_3 / 1000000).toFixed(1)}K</span>
                            <span>t CO2e</span>
                        </div>
                    </div>
                </div>
            ...
            <div className='scopes-container'>
                <div className='scopes'>
                    <div className='top'>
                        <span>Scope 3 Emission:</span>
                        <div>
                            <span>{(result4_1 / 1000000).toFixed(1)}K</span>
                            <span>t CO2e</span>
                        </div>
                    </div>
                </div>
            ...
            <div className='scopes-container'>
                <div className='scopes'>
                    <div className='top'>
                        <span>Scope 3 Emission:</span>
                        <div>
                            <span>{(result4_2 / 1000000).toFixed(1)}K</span>
                            <span>t CO2e</span>
                        </div>
                    </div>
                </div>
            ...
            <div className='scopes-container'>
                <div className='scopes'>
                    <div className='top'>
                        <span>Scope 3 Emission:</span>
                        <div>
                            <span>{(result5_1 / 1000000).toFixed(1)}K</span>
                            <span>t CO2e</span>
                        </div>
                    </div>
                </div>
            ...
            <div className='scopes-container'>
                <div className='scopes'>
                    <div className='top'>
                        <span>Scope 3 Emission:</span>
                        <div>
                            <span>{(result6_1 / 1000000).toFixed(1)}K</span>
                            <span>t CO2e</span>
                        </div>
                    </div>
                </div>
            ...
            <div className='scopes-container'>
                <div className='scopes'>
                    <div className='top'>
                        <span>Scope 3 Emission:</span>
                        <div>
                            <span>{(result6_2 / 1000000).toFixed(1)}K</span>
                            <span>t CO2e</span>
                        </div>
                    </div>
                </div>
            ...
            <div className='scopes-container'>
                <div className='scopes'>
                    <div className='top'>
                        <span>Scope 3 Emission:</span>
                        <div>
                            <span>{(result7_1 / 1000000).toFixed(1)}K</span>
                            <span>t CO2e</span>
                        </div>
                    </div>
                </div>
            ...
            <div className='scopes-container'>
                <div className='scopes'>
                    <div className='top'>
                        <span>Scope 3 Emission:</span>
                        <div>
                            <span>{(result8_1 / 1000000).toFixed(1)}K</span>
                            <span>t CO2e</span>
                        </div>
                    </div>
                </div>
            ...
            <div className='scopes-container'>
                <div className='scopes'>
                    <div className='top'>
                        <span>Scope 3 Emission:</span>
                        <div>
                            <span>{(result9_1 / 1000000).toFixed(1)}K</span>
                            <span>t CO2e</span>
                        </div>
                    </div>
                </div>
            ...
            <div className='scopes-container'>
                <div className='scopes'>
                    <div className='top'>
                        <span>Scope 3 Emission:</span>
                        <div>
                            <span>{(result9_2 / 1000000).toFixed(1)}K</span>
                            <span>t CO2e</span>
                        </div>
                    </div>
                </div>
            ...
            <div className='scopes-container'>
                <div className='scopes'>
                    <div className='top'>
                        <span>Scope 3 Emission:</span>
                        <div>
                            <span>{(result10_1 / 1000000).toFixed(1)}K</span>
                            <span>t CO2e</span>
                        </div>
                    </div>
                </div>
            ...
            <div className='scopes-container'>
                <div className='scopes'>
                    <div className='top'>
                        <span>Scope 3 Emission:</span>
                        <div>
                            <span>{(result10_2 / 1000000).toFixed(1)}K</span>
                            <span>t CO2e</span>
                        </div>
                    </div>
                </div>
            ...
            <div className='scopes-container'>
                <div className='scopes'>
                    <div className='top'>
                        <span>Scope 3 Emission:</span>
                        <div>
                            <span>{(result11_1 / 1000000).toFixed(1)}K</span>
                            <span>t CO2e</span>
                        </div>
                    </div>
                </div>
            ...
            <div className='scopes-container'>
                <div className='scopes'>
                    <div className='top'>
                        <span>Scope 3 Emission:</span>
                        <div>
                            <span>{(result12_1 / 1000000).toFixed(1)}K</span>
                            <span>t CO2e</span>
                        </div>
                    </div>
                </div>
            ...
            <div className='scopes-container'>
                <div className='scopes'>
                    <div className='top'>
                        <span>Scope 3 Emission:</span>
                        <div>
                            <span>{(result13_1 / 1000000).toFixed(1)}K</span>
                            <span>t CO2e</span>
                        </div>
                    </div>
                </div>
            ...
            <div className='scopes-container'>
                <div className='scopes'>
                    <div className='top'>
                        <span>Scope 3 Emission:</span>
                        <div>
                            <span>{(result13_2 / 1000000).toFixed(1)}K</span>
                            <span>t CO2e</span>
                        </div>
                    </div>
                </div>
            ...
            <div className='scopes-container'>
                <div className='scopes'>
                    <div className='top'>
                        <span>Scope 3 Emission:</span>
                        <div>
                            <span>{(result14_1 / 1000000).toFixed(1)}K</span>
                            <span>t CO2e</span>
                        </div>
                    </div>
                </div>
            ...
            <div className='scopes-container'>
                <div className='scopes'>
                    <div className='top'>
                        <span>Scope 3 Emission:</span>
                        <div>
                            <span>{(result14_2 / 1000000).toFixed(1)}K</span>
                            <span>t CO2e</span>
                        </div>
                    </div>
                </div>
